#!/bin/bash
# HackRX 12 Questions Test Script

# OPTIMIZED: 10 workers, 60 tokens, 3s timeout, temp=0
curl -X POST "https://b6539be2618a.ngrok-free.app/hackrx/run" \
...
echo "Test completed! Results saved to hackrx_dev.json"
echo "Checking file size..."
ls -la hackrx_dev.json
echo "Preview of results:"
head -20 hackrx_dev.json