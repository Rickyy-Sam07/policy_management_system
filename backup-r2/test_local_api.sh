...
echo "🚀 Testing Super RAG API - Local"
echo "==============================="

# Test with Newton's Principia (using localhost:8001)
curl -X POST "https://48e9bef37381.ngrok-free.app/hackrx/run" \
...
}' | python -m json.tool > test_results_local.json

echo ""
echo "✅ Local API test completed - Results saved to test_results_local.json"
echo "==============================="